...
Do not commit secrets. Use a local `.env` file and environment variables. If you rotate API keys, update `.env` and restart the app.

## License

No license file was found. If you plan to distribute this code, add a `LICENSE` file to clarify usage terms.